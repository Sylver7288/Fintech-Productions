          ...
          {(["email", "phone", "password", "confirmPassword"] as const).map((field) => (
            <View key={field} style={s.fieldWrap}>
              <Text style={[s.label, { color: colors.mutedForeground }]}>
                {field === "email" ? "Email address" : field === "phone" ? "Phone number" : field === "password" ? "Password" : "Confirm Password"}
              </Text>
              <View style={[s.inputWrap, { backgroundColor: colors.card, borderColor: colors.border }]}>
                <Feather
                ...
                <TextInput
                  style={[s.input, { color: colors.foreground }]}
                  placeholder={field === "email" ? "you@example.com" : field === "phone" ? "08012345678" : field === "password" ? "Min 8 characters" : "Confirm your password"}
                  placeholderTextColor={colors.mutedForeground}
                  value={form[field]}
                  onChangeText={update(field)}
                  autoCapitalize="none"
                  keyboardType={field === "email" ? "email-address" : field === "phone" ? "phone-pad" : "default"}
                  secureTextEntry={(field === "password" && !showPw) || (field === "confirmPassword" && !showConfirmPw)}
                />
                {field === "password" && (
